...
| Masa | Orar | Note |
|------|------|------|
| Mic dejun | *de stabilit* | |
| Prânz | *de stabilit* | |
| Gustare | ~20 min post-sală | |
| Cină | *de stabilit* | |

> **Orele** le fixăm împreună la pasul următor (depind de programul zilnic al Emei).

## Săptămâna curentă
*(Gol — se completează din rețetele validate. Sursa pentru lista de cumpărături.)*

| Zi | Mic dejun | Prânz | Gustare | Cină | kcal | P/G/C/Fibre |
|----|-----------|-------|---------|------|-----:|-------------|
| Luni | | | | | | |
| Marți | | | | | | |
| Miercuri | | | | | | |
...
> Verificare la final de săptămână: **pește de 2×**, **fibre 25–30 g/zi**, **zilele cu ouă alternate**.

## Meal prep & organizare bucătărie
*(Ce gătim în avans, cum depozităm, cum reducem risipa.)*
