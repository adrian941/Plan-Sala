...
| 📱 Site | [`index.html`](./index.html) + [`_site/`](./_site/) | Meniul pe zile, Ema / Amândoi / Adi — afișează `4b_meniu_zilnic.md`; se regenerează odată cu meniurile (`_site/data.js` din `genereaza.py`) | 🟢 |
