...
| `genereaza.py` | Scrie `comun/1_ingrediente.md`, `comun/2_retete.md`, `ema/4_meniu.md` + `ema/4b_meniu_zilnic.md`, `adi/4_meniu.md` + `adi/4b_meniu_zilnic.md` din cele două de mai sus. **`4_meniu.md` și `4b_meniu_zilnic.md` se scriu mereu din aceeași rulare** — nu există caz în care unul se actualizează fără celălalt. |
